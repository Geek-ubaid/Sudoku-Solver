...
"}")
        ...
        self.new_btn=QtWidgets.QPushButton(Solver)
    ...
    def retranslateUi(self, Solver):
        ...
        Solver.setWindowTitle(_translate("Solver", "Sudoku Solver"))
        self.label.setText(_translate("Solver", "Edit the sudoku and then click on solve button"))
        self.new_btn.setText(_translate("Solver","New Puzzle"))
